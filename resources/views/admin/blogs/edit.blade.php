        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Blog Yazısı Düzenle</h3>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.blogs.update', $blog->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="tags" id="tags" class="form-control" value="{{ old('tags', $blog->tags) }}" placeholder="Etiketleri virgülle ayırın">
                        ...
                        <div class="form-group">
                            ...
                            @if($blog->image)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/'.$blog->image) }}" alt="{{ $blog->title }}" class="img-thumbnail" style="max-height: 200px;">
                                </div>
                            @endif
